 ...
 * For ether transactions, `prefix` is "AVAX".
 * For token transaction, `prefix` is "AVAX-ERC20" and `data` is the tokenContractAddress.
 *
 *
 */
contract AvaxWalletSimple {
  // Events
  ...
  */
  ...
  function sendMultiSig(
    ...
    bytes32 operationHash = keccak256(abi.encodePacked("AVAX", toAddress, value, data, expireTime, sequenceId));
  ...
  function sendMultiSigToken(
    ...
    // Verify the other signer
    bytes32 operationHash = keccak256(abi.encodePacked("AVAX-ERC20", toAddress, value, tokenContractAddress, expireTime, sequenceId));
