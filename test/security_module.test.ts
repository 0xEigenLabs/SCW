...
describe('Module Registry', () => {
    ...
    it('should lock', async () => {
        ...
        await expect(securityModule.lock(wallet1.address)).to.be.revertedWith(
            'SM: must be signer/wallet'
        )

        await expect(
            securityModule.connect(user1).lock(wallet1.address)
